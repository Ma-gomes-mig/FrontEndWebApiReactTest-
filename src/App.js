...
function App() {
  const baseUrl="https://localhost:44363/api/Alunos";
  ...
  return (
    <div className="aluno-container">
      ...
      <header>
       ...
       <button className="btn btn-success" onClick={() => abrirFecharModalIncluir()}>Add new Students</button>
      </header>
      ...
      <Modal isOpen={modalExcluir}>
        ...
        <ModalFooter>
          <button className="btn btn-danger" onClick={()=> pedidoDelete()}>Sim</button> <button className="btn btn-secondary" onClick={()=> abrirFecharModalExcluir()}>Não</button>
        </ModalFooter>
      </Modal>
    </div>
  );
